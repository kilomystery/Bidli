...
export default function Payouts() {
  return (
    <div>
      <h2 style={{ marginTop: 0 }}>Pagamenti</h2>
      <div className="card">
        <div className="muted">Collega IBAN o Stripe (coming soon)</div>
        <div style={{ height:120, background:"#fafafa", border:"1px dashed #ddd", borderRadius:10 }} />
      </div>
    </div>
  );
}